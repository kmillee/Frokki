...
public class Constants {
    ...
    public static void setUpFrogList(){
        for (int i = 0 ; i < 13 ; i++){
            Frog frog = new Frog("media" + File.separator + "frog_" + i + ".png", "The Frog "+ i, FrogSpecies.getSpecies(i), "01/01/2025");
            FROGS.add(frog);
        }
    }
    ...
    // POND CONSTANTS
    public static final String POND_IMAGE =  "media" + File.separator + "pond" + File.separator + "pond.png";
    ...
    public static ImageIcon SCISSORS_IMG = new ImageIcon("media" + File.separator + "tool"+ File.separator + "scissors.png");
    public static ImageIcon NET_IMG = new ImageIcon("media" + File.separator + "tool" + File.separator + "net.png");
    public static ImageIcon GRAB_BEFORE_IMG = new ImageIcon("media" + File.separator + "tool" + File.separator + "grab_before.png");
    public static ImageIcon GRAB_WHILE_IMG = new ImageIcon("media" + File.separator + "tool" + File.separator + "grab_while.png");
    public static ImageIcon BIN_IMG = new ImageIcon("media"+ File.separator +"tool"+ File.separator +"bin.png");
    public static ImageIcon BELL_IMG = new ImageIcon("media"+ File.separator +"tool"+ File.separator +"bell.png");
