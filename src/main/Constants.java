...
public class Constants {
    ...
    // ---- TOOL ICONS ----
    public static final ImageIcon SCISSORS_IMG = new ImageIcon(RESOURCES_PATH + File.separator + "tool"+ File.separator + "scissors.png");
    public static final ImageIcon NET_IMG = new ImageIcon(RESOURCES_PATH + File.separator + "tool" + File.separator + "net.png");
    public static final ImageIcon GRAB_BEFORE_IMG = new ImageIcon(RESOURCES_PATH + File.separator + "tool" + File.separator + "grab_before.png");
    public static final ImageIcon GRAB_WHILE_IMG = new ImageIcon(RESOURCES_PATH + File.separator + "tool" + File.separator + "grab_while.png");
    public static final ImageIcon BIN_IMG = new ImageIcon(RESOURCES_PATH + File.separator +"tool"+ File.separator +"bin.png");
    public static final ImageIcon BELL_IMG = new ImageIcon(RESOURCES_PATH + File.separator +"tool"+ File.separator +"bell.png");
